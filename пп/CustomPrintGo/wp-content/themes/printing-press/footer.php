...
<footer class="footer-side">
  <?php if( get_theme_mod( 'printing_press_show_footer_widget',true)) : ?>
  ...
  <?php endif; ?>
  <?php if( get_theme_mod( 'printing_press_show_footer_copyright',true)) : ?>  
    <div class="footer-copyright">
      <div class="container">
          ...
          <div class="col-lg-6 col-md-6 align-self-center">
            <p class="mb-0 py-3 text-center text-md-start">
              <?php
                ...
                <a href="<?php echo esc_url(__('https://www.wpelemento.com/products/free-printing-wordpress-theme', 'printing-press' )); ?>" target="_blank">   
        ...
        <?php if(get_theme_mod('printing_press_footer_social_icon_hide', false )== true){ ?>
          <div class="row">
            <div class="col-12 align-self-center py-1">
              <div class="footer-links">
                <?php $printing_press_settings_footer = get_theme_mod( 'printing_press_social_links_settings_footer' ); ?>
                <?php if ( is_array($printing_press_settings_footer) || is_object($printing_press_settings_footer) ){ ?>
                  <?php foreach( $printing_press_settings_footer as $printing_press_setting_footer ) { ?>
                    <a href="<?php echo esc_url( $printing_press_setting_footer['link_url'] ); ?>" target="_blank">
                      <i class="<?php echo esc_attr( $printing_press_setting_footer['link_text'] ); ?> me-2"></i>
                    </a>
                  <?php } ?>
                <?php } ?>
              </div>
