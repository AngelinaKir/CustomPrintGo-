  ...
  <div class="container">
    <?php if ( get_theme_mod('printing_press_header_page_title' , true)) : ?>
        ...
        <div class="headerimgbox-meta">
          ...
          <?php endwhile; ?>
          <span class="ms-3"><i class="far fa-comments me-2"></i> <?php comments_number( esc_attr('0', 'printing-press'), esc_attr('0', 'printing-press'), esc_attr('%', 'printing-press') ); ?> <?php esc_html_e('comments','printing-press'); ?></span>
        </div>
    <?php endif; ?>
