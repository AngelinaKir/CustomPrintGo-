...
?>
    ...
    <div class="inner-cont">
	    ...
	    <div class="tab-sec">
	    	<div class="tab">
				<button class="tablinks" onclick="printing_press_open_tab(event, 'wpelemento_importer_editor')"><?php esc_html_e( 'Setup With Elementor', 'printing-press' ); ?></button>
			...
			<div id="wpelemento_importer_editor" class="tabcontent open">
				...
				<?php }else{ ?>
					<div class="tab-outer-box">
						<h3><?php esc_html_e('Welcome to WPElemento Theme!', 'printing-press'); ?></h3>
						<p><?php esc_html_e('Click on the quick start button to import the demo.', 'printing-press'); ?></p>
						<div class="info-link">
							<a  href="<?php echo esc_url( admin_url('admin.php?page=wpelementoimporter-wizard') ); ?>"><?php esc_html_e('Quick Start', 'printing-press'); ?></a>
						</div>
					</div>
				<?php } ?>
			</div>
		...
		<div class="inner-side-content">
			...
			<div class="tab-outer-box">
				...
				<div class="iner-sidebar-pro-btn">
					<span class="premium-btn"><a href="<?php echo esc_url( PRINTING_PRESS_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Buy Premium', 'printing-press'); ?></a>
					</span>
					...
					<span class="doc-btn"><a href="<?php echo esc_url( PRINTING_PRESS_THEME_BUNDLE ); ?>" target="_blank"><?php esc_html_e('Theme Bundle', 'printing-press'); ?></a>
					</span>
				</div>
				<hr>
