	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Printing_Press_Customize_Section_Pro(
				...
				array(
					...
					'pro_text'    => esc_html__( 'GET PRO', 'printing-press' ),
					'pro_url'     => 'https://www.wpelemento.com/products/printing-press-wordpress-theme',
					'priority'    => 5,
				)
			)
		);
		$manager->add_section(
			new Printing_Press_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://preview.wpelemento.com/theme-documentation/printing-press/',
					'priority'    => 5,
				)
			)
		);
		...
		$manager->add_section(
			new Printing_Press_Customize_Section_Pro(
				...
				'printing-press-demo',
				array(
					'title'       => esc_html__( 'Pro Demo link', 'printing-press' ),
					'pro_text'    => esc_html__( 'Demo', 'printing-press' ),
					'pro_url'     => 'https://preview.wpelemento.com/printing-press/',
					'priority'    => 5,
				)
			)
		);
