...
<main id="content">
  <?php if( get_option('clothing_store_slider_arrows', false) !== 'off'){ ?>
    <section id="slider">
      <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <?php $clothing_store_slider_count = get_theme_mod('clothing_store_slider_count'); ?>
              <?php
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
            ...
            <div class="carousel-caption slider-inner">
              <?php if( get_theme_mod('clothing_store_slide_heading') != ''){ ?>
                <h3><?php echo esc_html(get_theme_mod('clothing_store_slide_heading','')); ?></h3>
              <?php }?>
  ...
  <?php }?>
  <?php if( get_option('t_shirt_clothing_product_cat_enable', false) !== 'off'){ ?>
      <div id="pro_cat" class="py-5 text-center">
        <div class="container">
          ...
          <div class="row">
            ...
            $t_shirt_clothing_page_query = new WP_Query(array( 

              'category_name' => esc_html($t_shirt_clothing_catData1 ,'t-shirt-clothing'),

              'order' => 'ASC',

              'posts_per_page' => get_theme_mod('t_shirt_clothing_cat_count')
  ...
  <?php }?>
  <?php if( get_option('clothing_store_product_enable', false) !== 'off'){ ?>
