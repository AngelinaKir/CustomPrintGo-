...
function t_shirt_clothing_customize_register() {
  	...
  	$wp_customize->remove_setting( 'clothing_store_primary_color' );
  	$wp_customize->remove_control( 'clothing_store_primary_color' );

  	$wp_customize->remove_setting( 'clothing_store_heading_color' );
  	$wp_customize->remove_control( 'clothing_store_heading_color' );

  	$wp_customize->remove_setting( 'clothing_store_primary_fade' );
  	$wp_customize->remove_control( 'clothing_store_primary_fade' );

  	$wp_customize->remove_setting( 'clothing_store_footer_bg' );
  	$wp_customize->remove_control( 'clothing_store_footer_bg' );

  	$wp_customize->remove_setting( 'clothing_store_slider_opacity' );
  	$wp_customize->remove_control( 'clothing_store_slider_opacity' );
}
...
wp_enqueue_style('customizercustom_css', esc_url( get_stylesheet_directory_uri() ). '/assets/css/customizer.css');
	...
	$wp_customize->add_setting('t_shirt_clothing_slider_content_alignment',array(
        'default' => 'RIGHT-ALIGN',
        'sanitize_callback' => 'clothing_store_sanitize_choices'
	));
	$wp_customize->add_control('t_shirt_clothing_slider_content_alignment',array(
		'type' => 'radio',
		'label'     => __('Slider Content Alignment', 't-shirt-clothing'),
		'section' => 'clothing_store_slider_section',
		'type' => 'select',
		'choices' => array(
	...
	$wp_customize->add_setting('t_shirt_clothing_slider_opacity',array(
        'default' => '0.5',
        'sanitize_callback' => 'clothing_store_sanitize_choices'
	));
	$wp_customize->add_control('t_shirt_clothing_slider_opacity',array(
		'type' => 'radio',
		'label'     => __('Slider Opacity', 't-shirt-clothing'),
		'section' => 'clothing_store_slider_section',
		'type' => 'select',
		'choices' => array(
			'0' => __('0','t-shirt-clothing'),
			'0.1' => __('0.1','t-shirt-clothing'),
			'0.2' => __('0.2','t-shirt-clothing'),
			'0.3' => __('0.3','t-shirt-clothing'),
			'0.4' => __('0.4','t-shirt-clothing'),
			'0.5' => __('0.5','t-shirt-clothing'),
			'0.6' => __('0.6','t-shirt-clothing'),
			'0.7' => __('0.7','t-shirt-clothing'),
			'0.8' => __('0.8','t-shirt-clothing'),
			'0.9' => __('0.9','t-shirt-clothing'),
			'1' => __('1','t-shirt-clothing')
		),
	) );
	...
	$wp_customize->add_setting('t_shirt_clothing_cat_count',array(
		'default'	=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('t_shirt_clothing_cat_count',array(
		'label'	=> esc_html__('Post Count','t-shirt-clothing'),
		'section'	=> 't_shirt_clothing_product_category',
		'type'		=> 'number',
	));
	...
	$wp_customize->add_setting('t_shirt_clothing_primary_color', array(
	    'default' => '#e5523e',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 't_shirt_clothing_primary_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Theme Color', 't-shirt-clothing'),
	 
	)));

	$wp_customize->add_setting('t_shirt_clothing_heading_color', array(
	    'default' => '#131313',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 't_shirt_clothing_heading_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Theme Heading Color', 't-shirt-clothing'),
	 
	)));

	$wp_customize->add_setting('t_shirt_clothing_primary_fade', array(
	    'default' => '#ffedea',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 't_shirt_clothing_primary_fade', array(
	    'section' => 'colors',
	    'label' => esc_html__('theme Color Light', 't-shirt-clothing'),
	 
	)));

	$wp_customize->add_setting('t_shirt_clothing_footer_bg', array(
	    'default' => '#131313',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 't_shirt_clothing_footer_bg', array(
	    'section' => 'colors',
	    'label' => esc_html__('Footer Bg color', 't-shirt-clothing'),
	)));
}
...
if (class_exists('WP_Customize_Control') && !class_exists('T_Shirt_Clothing_Pro_Control')):
    ...
    public function render_content(){?>
        <label style="overflow: hidden; zoom: 1;">
            ...
            <div class="col-md">
                <h3 style="margin-top:10px; margin-left: 20px; font-size:12px; text-decoration:underline; color:#333;"><?php esc_html_e('CLOTHING PREMIUM - Features', 't-shirt-clothing'); ?></h3>
