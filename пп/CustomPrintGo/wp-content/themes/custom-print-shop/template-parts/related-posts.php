					    ...
					    <div class="services-box">    
					      	...
					      	<div class="lower-box">
						        ...
						        <?php if(get_the_excerpt()) { ?>
						            <p><?php $custom_print_shop_excerpt = get_the_excerpt(); echo esc_html( custom_print_shop_string_limit_words( $custom_print_shop_excerpt, esc_attr(get_theme_mod('custom_print_shop_related_post_excerpt_number','20')))); ?><?php echo esc_html( get_theme_mod('custom_print_shop_button_excerpt_suffix','[...]') ); ?></p>
						        <?php }?>
