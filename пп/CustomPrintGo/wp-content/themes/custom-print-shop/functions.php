...
function custom_print_shop_scripts() {
	...
	$custom_print_shop_body_font_weight = get_theme_mod('custom_print_shop_body_font_weight', '');
	// Paragraph
	...
	$custom_print_shop_paragraph_font_weight = get_theme_mod('custom_print_shop_paragraph_font_weight', '');
	// "a" tag
	...
	$custom_print_shop_atag_font_weight = get_theme_mod('custom_print_shop_atag_font_weight', '');
	// "li" tag
	...
	$custom_print_shop_li_font_weight = get_theme_mod('custom_print_shop_li_font_weight', '');
	// H1
	...
	$custom_print_shop_h1_font_weight = get_theme_mod('custom_print_shop_h1_font_weight', '');
	// H2
	...
	$custom_print_shop_h2_font_weight = get_theme_mod('custom_print_shop_h2_font_weight', '');
	// H3
	...
	$custom_print_shop_h3_font_weight = get_theme_mod('custom_print_shop_h3_font_weight', '');
	// H4
	...
	$custom_print_shop_h4_font_weight = get_theme_mod('custom_print_shop_h4_font_weight', '');
	// H5
	...
	$custom_print_shop_h5_font_weight = get_theme_mod('custom_print_shop_h5_font_weight', '');
	// H6
	...
	$custom_print_shop_h6_font_weight = get_theme_mod('custom_print_shop_h6_font_weight', '');

	//footer icon color
	$custom_print_shop_footer_icon_color = get_theme_mod('custom_print_shop_footer_icon_color', '');	
	...
	$custom_print_shop_custom_css ='
	    body{
			...
			font-weight: '.esc_attr($custom_print_shop_body_font_weight).'!important;
		}
		p,span{
		    ...
		    font-size: '.esc_attr($custom_print_shop_paragraph_font_size).'px !important;
			font-weight: '.esc_attr($custom_print_shop_paragraph_font_weight).'!important;
		}
		a{
		    color:'.esc_attr($custom_print_shop_atag_color).'!important;
		    font-family: '.esc_attr($custom_print_shop_atag_font_family).';
			font-weight: '.esc_attr($custom_print_shop_atag_font_weight).'!important;
		}
		li{
		    color:'.esc_attr($custom_print_shop_li_color).'!important;
		    font-family: '.esc_attr($custom_print_shop_li_font_family).';
			font-weight: '.esc_attr($custom_print_shop_li_font_weight).'!important;
		}
		h1{
		    color:'.esc_attr($custom_print_shop_h1_color).'!important;
		    font-family: '.esc_attr($custom_print_shop_h1_font_family).'!important;
		    font-size: '.esc_attr($custom_print_shop_h1_font_size).'px !important;
			font-weight: '.esc_attr($custom_print_shop_h1_font_weight).'!important;
		}
		h2{
		    color:'.esc_attr($custom_print_shop_h2_color).'!important;
		    font-family: '.esc_attr($custom_print_shop_h2_font_family).'!important;
		    font-size: '.esc_attr($custom_print_shop_h2_font_size).'px !important;
			font-weight: '.esc_attr($custom_print_shop_h2_font_weight).'!important;
		}
		h3{
		    color:'.esc_attr($custom_print_shop_h3_color).'!important;
		    font-family: '.esc_attr($custom_print_shop_h3_font_family).'!important;
		    font-size: '.esc_attr($custom_print_shop_h3_font_size).'px !important;
			font-weight: '.esc_attr($custom_print_shop_h3_font_weight).'!important;
		}
		h4{
		    color:'.esc_attr($custom_print_shop_h4_color).'!important;
		    font-family: '.esc_attr($custom_print_shop_h4_font_family).'!important;
		    font-size: '.esc_attr($custom_print_shop_h4_font_size).'px !important;
			font-weight: '.esc_attr($custom_print_shop_h4_font_weight).'!important;
		}
		h5{
		    color:'.esc_attr($custom_print_shop_h5_color).'!important;
		    font-family: '.esc_attr($custom_print_shop_h5_font_family).'!important;
		    font-size: '.esc_attr($custom_print_shop_h5_font_size).'px !important;
			font-weight: '.esc_attr($custom_print_shop_h5_font_weight).'!important;
		}
		h6{
		    color:'.esc_attr($custom_print_shop_h6_color).'!important;
		    font-family: '.esc_attr($custom_print_shop_h6_font_family).'!important;
		    font-size: '.esc_attr($custom_print_shop_h6_font_size).'px !important;
			font-weight: '.esc_attr($custom_print_shop_h6_font_weight).'!important;
		}
		...
		#footer .socialicons a{
			color:'.esc_attr($custom_print_shop_footer_icon_color).'!important;
	    }			
...
// URL DEFINES
define('CUSTOM_PRINT_SHOP_SITE_URL',__('https://www.themescaliber.com/products/free-print-shop-wordpress-theme','custom-print-shop'));
define('CUSTOM_PRINT_SHOP_FREE_THEME_DOC',__('https://preview.themescaliber.com/doc/custom-print-shop/','custom-print-shop'));
...
define('CUSTOM_PRINT_SHOP_BUY_NOW',__('https://www.themescaliber.com/products/print-on-demand-wordpress-theme','custom-print-shop'));
define('CUSTOM_PRINT_SHOP_LIVE_DEMO',__('https://preview.themescaliber.com/custom-print-shop-pro/','custom-print-shop'));
define('CUSTOM_PRINT_SHOP_PRO_DOC',__('https://preview.themescaliber.com/doc/custom-print-shop-pro/','custom-print-shop'));

function custom_print_shop_credit_link() {
    echo "<a href=".esc_url(CUSTOM_PRINT_SHOP_SITE_URL)." target='_blank'>".esc_html__('Print Shop WordPress Theme','custom-print-shop')."</a>";
}
