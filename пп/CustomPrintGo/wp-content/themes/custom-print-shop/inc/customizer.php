...
function custom_print_shop_customize_register( $wp_customize ) {
	...
	//About Section
		...
		$wp_customize->add_control('custom_print_shop_review_link',array(
			'type'=> 'hidden',
			'description' => "<h3>". esc_html('Theme Review','custom-print-shop') ."</h3><p>". esc_html('If you enjoy using our theme, we’d love to hear your feedback. please leave us a review.','custom-print-shop') ."</p><a target='_blank' href='". esc_url('https://wordpress.org/support/theme/custom-print-shop/reviews/#new-post') ." '>". esc_html('Rate & Review','custom-print-shop') ."</a>",
			'section'=> 'custom_print_shop_about_theme'
		));			
    ...
    $wp_customize->add_control('custom_print_shop_menu_settings_premium_features', array(
        ...
        'description' => "<h3>". esc_html('More Features in the Premium Version!','custom-print-shop') ."</h3>
        	...
        	<a target='_blank' href='". esc_url('https://www.themescaliber.com/products/print-on-demand-wordpress-theme') ." '>". esc_html('Upgrade Now','custom-print-shop') ."</a>",
        'section' => 'custom_print_shop_header'
        )
    );
   ...
   $wp_customize->add_setting('custom_print_shop_tagline_title',array(
	...
	$wp_customize->add_section( 'custom_print_shop_button_option', array(
		'title' => __('Button Settings','custom-print-shop'),
		'panel' => 'custom_print_shop_panel_id',
	));
	...
	$wp_customize->add_control(new Custom_Print_Shop_Icon_Changer(
		$wp_customize,'custom_print_shop_footer_facebook_icon',array(
	...
	$wp_customize->add_control(new Custom_Print_Shop_Icon_Changer(
		$wp_customize,'custom_print_shop_footer_twitter_icon',array(
	...
	$wp_customize->add_control(new Custom_Print_Shop_Icon_Changer(
		$wp_customize,'custom_print_shop_footer_instagram_icon',array(
	...
	$wp_customize->add_control(new Custom_Print_Shop_Icon_Changer(
		$wp_customize,'custom_print_shop_footer_pintrest_icon',array(
	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Custom_Print_Shop_Customizer_Upsell_Section(
				$manager, 'custom-print-shop-upsell-frontpage-sections', array(
					'panel'       => 'custom_print_shop_panel_id',
					'priority'    => 500,
					'options'     => array(
