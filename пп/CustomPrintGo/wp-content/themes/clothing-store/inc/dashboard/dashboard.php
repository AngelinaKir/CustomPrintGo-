...
if ( ! defined( 'CLOTHING_STORE_BUNDLE_LINK' ) ) {
define('CLOTHING_STORE_BUNDLE_LINK',__('https://www.ovationthemes.com/products/wordpress-bundle','clothing-store'));
}
if ( ! defined( 'CLOTHING_STORE_BUNDLE_LINK' ) ) {
define('CLOTHING_STORE_BUNDLE_LINK',__('https://www.ovationthemes.com/products/wordpress-bundle','clothing-store'));
}
...
function clothing_store_guide() {
	...
	<div class="getting-started__header">
		<div class="header-box-left">
			<h2><?php echo esc_html( $clothing_store_theme ); ?></h2>
			<p><?php esc_html_e('Version: ', 'clothing-store'); ?><?php echo esc_html($clothing_store_theme['Version']);?></p>
		</div>
	...
	<div class="import-box">
		<div class="box-container">
			<h2><?php esc_html_e( 'DEMO IMPORT', 'clothing-store' ); ?></h2>
			<p><?php esc_html_e('To import all of the demo content, click the Begin With Demo Import button.','clothing-store'); ?></p>
		...
		<div class="box-container">
			<div class="box-left-main">
				<div class="leftbox">
					...
					<p><?php esc_html_e('To setup the Clothing Store theme follow the below steps.','clothing-store'); ?></p>
					...
					<p><?php esc_html_e('Go to dashboard >> Appearance >> Customize >> Custom Page Settings >> Header >> Add your phone number and email address.','clothing-store'); ?></p>
					...
					<p><?php esc_html_e('Go to dashboard >> Appearance >> Customize >> Custom Page Settings >> Social Media >> Add social links.','clothing-store'); ?></p>
					...
					<h4><?php esc_html_e('6. Setup Footer Text','clothing-store'); ?></h4>
					<p><?php esc_html_e('Go to dashboard >> Appearance >> Customize >> Custom Page Settings >> Footer Text >> Add copyright text.','clothing-store'); ?></p>
					...
					<p><?php esc_html_e('To setup the home page follow the below steps.','clothing-store'); ?></p>
					...
					<p><?php esc_html_e('Go to dashboard >> Appearance >> Customize >> Custom Page Settings >> Slider Settings >> Select post.','clothing-store'); ?></p>
			...
			<div class="box-right-main">
				...
				<img class="clothing_store_img_responsive" style="width: 100%;" src="<?php echo esc_url( $clothing_store_theme->get_screenshot() ); ?>" />
				<div class="pro-links">
					<div class="pro-links-inner">
						...
						<a class="button-primary bundle-btn" href="<?php echo esc_url( CLOTHING_STORE_BUNDLE_LINK ); ?>" target="_blank"><?php esc_html_e('Wordpress Theme Bundle (100+ Themes at Just $89)', 'clothing-store'); ?></a>
				</div>
