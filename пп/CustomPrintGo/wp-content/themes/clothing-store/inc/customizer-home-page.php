 ...
 */
	...
	$wp_customize->add_setting('clothing_store_slide_heading',array(
		'default' => '',
		'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control('clothing_store_slide_heading',array(
		'label' => esc_html__('Slider Text','clothing-store'),
		'section' => 'clothing_store_slider_section',
		'setting' => 'clothing_store_slide_heading',
		'type'    => 'text',
		'priority'   => 1,
	));

	$wp_customize->add_setting('clothing_store_slider_count',array(
		'default'	=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('clothing_store_slider_count',array(
		'label'	=> esc_html__('Slider Count','clothing-store'),
		'section'	=> 'clothing_store_slider_section',
		'description' => __( 'After increasing/decreasing counter refresh site for changes to be applied.', 'clothing-store' ),
		'type'		=> 'number',
		'priority'   => 1,
	));

	$clothing_store_slider_count = get_theme_mod('clothing_store_slider_count');
	...
	for ( $i = 1; $i <= $clothing_store_slider_count; $i++ ) {
	...
	$wp_customize->add_setting('clothing_store_slider_opacity',array(
        'default' => '1',
        'sanitize_callback' => 'clothing_store_sanitize_choices'
	));
	$wp_customize->add_control('clothing_store_slider_opacity',array(
		'type' => 'radio',
		'label'     => __('Slider Opacity', 'clothing-store'),
		'section' => 'clothing_store_slider_section',
		'type' => 'select',
		'choices' => array(
			'0' => __('0','clothing-store'),
			'0.1' => __('0.1','clothing-store'),
			'0.2' => __('0.2','clothing-store'),
			'0.3' => __('0.3','clothing-store'),
			'0.4' => __('0.4','clothing-store'),
			'0.5' => __('0.5','clothing-store'),
			'0.6' => __('0.6','clothing-store'),
			'0.7' => __('0.7','clothing-store'),
			'0.8' => __('0.8','clothing-store'),
			'0.9' => __('0.9','clothing-store'),
	...
	$wp_customize->add_setting('clothing_store_millions_of_hours_number',array(
		'default'	=> '',
		'sanitize_callback'	=> 'sanitize_text_field',
	));
	$wp_customize->add_control('clothing_store_millions_of_hours_number',array(
		'label'	=> __('Number of products to show in a category','clothing-store'),
		'section' => 'clothing_store_millions_of_hours_section',
		'type'	  => 'number',
	));
	...
	$wp_customize->add_setting('clothing_store_footer_content_alignment',array(
        'default' => 'CENTER-ALIGN',
        'sanitize_callback' => 'clothing_store_sanitize_choices'
	));
	$wp_customize->add_control('clothing_store_footer_content_alignment',array(
		'type' => 'radio',
		'label'     => __('Footer Content Alignment', 'clothing-store'),
		'section' => 'clothing_store_footer_copyright',
		'type' => 'select',
		'choices' => array(
			'LEFT-ALIGN' => __('LEFT','clothing-store'),
	...
	$wp_customize->add_control('clothing_store_footer_widget',array(
		'type' => 'radio',
		'label'     => __('Footer Per Column', 'clothing-store'),
		'section' => 'clothing_store_footer_copyright',
		'type' => 'select',
		'choices' => array(
			'1' => __('1','clothing-store'),
