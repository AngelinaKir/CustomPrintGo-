...
function clothing_store_customize_register( $wp_customize ) {
	...
	$wp_customize->register_control_type( 'Clothing_Store_Control_Sortable' );
  	...
  	add_action( 'customize_controls_enqueue_scripts', function() {
    	wp_enqueue_script(
	        'clothing-store-customizer-reset',
	...
	if ( $wp_customize->get_section( 'colors' ) ) {
        $wp_customize->get_section( 'colors' )->title = __( 'Global Colors', 'clothing-store' );
        $wp_customize->get_section( 'colors' )->priority = 2;
    }

    $wp_customize->add_setting( 'clothing_store_global_color_heading', array(
		'default'           => '',
		'transport'         => 'refresh',
		'sanitize_callback' => 'sanitize_text_field',
	) );
	$wp_customize->add_control( new Clothing_Store_Customizer_Customcontrol_Section_Heading( $wp_customize, 'clothing_store_global_color_heading', array(
			'label'       => esc_html__( 'Global Colors', 'clothing-store' ),
			'section'     => 'colors',
			'settings'    => 'clothing_store_global_color_heading',
			'priority'       => 1,

	) ) );

	$wp_customize->add_setting( 'clothing_store_reset_colors', array(
	    'default'           => '',
	    'sanitize_callback' => 'sanitize_text_field',
	    'transport'         => 'postMessage', 
	) );

	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'clothing_store_reset_colors', array(
	    'label'       => esc_html__( 'Reset Colors', 'clothing-store' ),
	    'section'     => 'colors',
	    'settings'    => 'clothing_store_reset_colors',
	    'type'        => 'button',
	    'input_attrs' => array(
    ...
    $wp_customize->add_setting('clothing_store_primary_color', array(
	    'default' => '#7dc8db',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'clothing_store_primary_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Theme Color', 'clothing-store'),
	 
	)));

	$wp_customize->add_setting('clothing_store_footer_bg', array(
	    'default' => '#3A4357',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'clothing_store_footer_bg', array(
	    'section' => 'colors',
	    'label' => esc_html__('second color', 'clothing-store'),
	)));

	$wp_customize->add_setting('clothing_store_heading_color', array(
	    'default' => '#3b4358',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'clothing_store_heading_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Theme Heading Color', 'clothing-store'),
	 
	)));

	$wp_customize->add_setting('clothing_store_text_color', array(
	    'default' => '#777777',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'clothing_store_text_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Theme Text Color', 'clothing-store'),
	 
	)));

	$wp_customize->add_setting('clothing_store_primary_fade', array(
	    'default' => '#e7faff',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'clothing_store_primary_fade', array(
	    'section' => 'colors',
	    'label' => esc_html__('theme Color Light', 'clothing-store'),
	 
	)));

	$wp_customize->add_setting('clothing_store_post_bg', array(
	    'default' => '#ffffff',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'clothing_store_post_bg', array(
	    'section' => 'colors',
	    'label' => esc_html__('sidebar/Blog Post Bg color', 'clothing-store'),
	)));
	...
	$wp_customize->add_section('clothing_store_blog_meta',array(
        'title' => __('Blog Meta', 'clothing-store'), 
        'panel' => 'clothing_store_post_panel',       
    ) );

    $wp_customize->add_setting( 'clothing_store_section_blog_meta_heading', array(
		'default'           => '',
		'transport'         => 'refresh',
		'sanitize_callback' => 'sanitize_text_field',
	) );
	$wp_customize->add_control( new Clothing_Store_Customizer_Customcontrol_Section_Heading( $wp_customize, 'clothing_store_section_blog_meta_heading', array(
		'label'       => esc_html__( 'Blog Meta Settings', 'clothing-store' ),
		'section'     => 'clothing_store_blog_meta',
		'settings'    => 'clothing_store_section_blog_meta_heading',
	) ) );
	...
	$wp_customize->add_setting('clothing_store_date_type',array(
        'default' => 'published',
        'sanitize_callback' => 'clothing_store_sanitize_choices'
	));
	$wp_customize->add_control('clothing_store_date_type',array(
		'type' => 'radio',
		'label'     => __('Date Format', 'clothing-store'),
		'section' => 'clothing_store_blog_meta',
		'type' => 'select',
		'choices' => array(
			'published' => __('published date','clothing-store'),
            'modified' => __('modified date','clothing-store'),
		),
	) );
	...
	$wp_customize->add_control('clothing_store_grid_column',array(
		'type' => 'radio',
		'label'     => __('Grid Post Per Row', 'clothing-store'),
		'section' => 'clothing_store_archieve_post_layot',
		'type' => 'select',
		'choices' => array(
	...
	// woocommerce
	if ( class_exists( 'WooCommerce' ) ){
		$wp_customize->add_section('clothing_store_woocoomerce_section',array(
	        'title' => __('Custom Woocommerce Settings', 'clothing-store'),
	        'panel' => 'woocommerce',
	        'priority' => 4,
	    ) );
		...
		$wp_customize->add_control( new Clothing_Store_Customizer_Customcontrol_Section_Heading( $wp_customize, 'clothing_store_section_shoppage_heading', array(
			...
			'section'     => 'clothing_store_woocoomerce_section',
...
if (class_exists('WP_Customize_Control') && !class_exists('Clothing_Store_Pro_Control')):
    ...
    public function render_content(){?>
        <label style="overflow: hidden; zoom: 1;">
	        ...
	        <div class="col-md">
	            <h3 style="margin-top:10px; margin-left: 20px; font-size:12px; text-decoration:underline; color:#333;"><?php esc_html_e('Clothing Store PREMIUM - Features', 'clothing-store'); ?></h3>
