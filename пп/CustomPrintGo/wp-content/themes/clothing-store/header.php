						...
						<div class="row">							
							<div class="col-lg-4 col-md-4 col-sm-4 align-self-center text-md-center text-lg-start header-text">
								<?php if( get_theme_mod('clothing_store_top_phone') != '' ){ ?>
									<span><i class="<?php echo esc_html(get_theme_mod('clothing_store_top_phone_icon','')); ?> me-3"></i><?php esc_html_e('HOTLINE','clothing-store'); ?> <a href="tel:<?php echo esc_attr(get_theme_mod('clothing_store_top_phone', '')); ?>"><?php echo esc_html(get_theme_mod('clothing_store_top_phone', '')); ?></a></span>
								<?php }?>
							</div>
							<div class="col-lg-4 col-md-4 col-sm-4 align-self-center text-md-center text-lg-start header-text">
