        ...
        <div class="owl-carousel" role="listbox">
          ...
          <?php } ?>
              <div class="slider-inner-box">
                <?php if(get_theme_mod('ecommerce_zone_slider_title_setting',1) == 1){ ?>
                  <h2><?php the_title(); ?></h2>
                <?php }?>
                <?php if(get_theme_mod('ecommerce_zone_slider_button_setting',1) == 1 && get_theme_mod('ecommerce_zone_slider_button_text','SHOP NOW') != ''){ ?>
                  <div class="more-btn">
                    <a href="<?php the_permalink(); ?>"><?php esc_html_e(get_theme_mod('ecommerce_zone_slider_button_text','SHOP NOW')); ?><i class="fas fa-caret-right"></i></a>
                  </div>
                <?php }?>
              </div>
            </div>
