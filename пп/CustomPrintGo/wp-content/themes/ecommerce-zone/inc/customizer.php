...
if ( ! defined( 'ECOMMERCE_ZONE_URL' ) ) {
    define( 'ECOMMERCE_ZONE_URL', esc_url( 'https://www.themagnifico.net/products/ecommerce-wordpress-theme', 'ecommerce-zone') );
}
...
function ecommerce_zone_customize_register($wp_customize){
    ...
    $wp_customize->add_setting('ecommerce_zone_site_width_layout',array(
        'default' => 'Full Width',
        'sanitize_callback' => 'ecommerce_zone_sanitize_choices'
    ));
    $wp_customize->add_control('ecommerce_zone_site_width_layout',array(
        'label'       => esc_html__( 'Site Width Layout','ecommerce-zone' ),
        'type' => 'radio',
        'section' => 'ecommerce_zone_general_settings',
        'choices' => array(
            'Full Width' => __('Full Width','ecommerce-zone'),
            'Wide Width' => __('Wide Width','ecommerce-zone'),
            'Container Width' => __('Container Width','ecommerce-zone')
        ),
    ) );
    ...
    $wp_customize->add_control('ecommerce_zone_scroll_top_position',array(
        'label'       => esc_html__( 'Scroll To Top Positions','ecommerce-zone' ),
        'type' => 'radio',
        'section' => 'ecommerce_zone_general_settings',
        'choices' => array(
    ...
    $wp_customize->add_setting( 'ecommerce_zone_scroll_bg_color', array(
        'default' => '',
        'sanitize_callback' => 'sanitize_hex_color'
    ));
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'ecommerce_zone_scroll_bg_color', array(
        'label' => esc_html__('Scroll Top Background Color','ecommerce-zone'),
        'section' => 'ecommerce_zone_general_settings',
        'settings' => 'ecommerce_zone_scroll_bg_color'
    )));

    $wp_customize->add_setting( 'ecommerce_zone_scroll_color', array(
        'default' => '',
        'sanitize_callback' => 'sanitize_hex_color'
    ));
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'ecommerce_zone_scroll_color', array(
        'label' => esc_html__('Scroll Top Color','ecommerce-zone'),
        'section' => 'ecommerce_zone_general_settings',
        'settings' => 'ecommerce_zone_scroll_color'
    )));

    $wp_customize->add_setting('ecommerce_zone_scroll_font_size',array(
        'default'   => '16',
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('ecommerce_zone_scroll_font_size',array(
        'label' => __('Scroll Top Font Size','ecommerce-zone'),
        'description' => __('Put in px','ecommerce-zone'),
        'section'   => 'ecommerce_zone_general_settings',
        'type'      => 'number'
    ));

    $wp_customize->add_setting( 'ecommerce_zone_scroll_to_top_border_radius', array(
        'default'              => '',
        'transport'            => 'refresh',
        'sanitize_callback'    => 'ecommerce_zone_sanitize_number_range'
    ) );
    $wp_customize->add_control( 'ecommerce_zone_scroll_to_top_border_radius', array(
        'label'       => esc_html__( 'Scroll To Top Border Radius','ecommerce-zone' ),
        'section'     => 'ecommerce_zone_general_settings',
        'type'        => 'range',
        'input_attrs' => array(
            'step'             => 1,
    ...
    $wp_customize->add_control('ecommerce_zone_woocommerce_product_sale',array(
        'label'       => esc_html__( 'Woocommerce Product Sale Positions','ecommerce-zone' ),
        'type' => 'radio',
        'section' => 'ecommerce_zone_general_settings',
        'choices' => array(
            'Right' => __('Right','ecommerce-zone'),
    ...
    $wp_customize->add_setting( 'ecommerce_zone_woo_product_sale_border_radius', array(
        'default'              => '',
        'transport'            => 'refresh',
        'sanitize_callback'    => 'ecommerce_zone_sanitize_number_range'
    ) );
    $wp_customize->add_control( 'ecommerce_zone_woo_product_sale_border_radius', array(
        'label'       => esc_html__( 'Woocommerce Product Sale Border Radius','ecommerce-zone' ),
        'section'     => 'ecommerce_zone_general_settings',
        'type'        => 'range',
        'input_attrs' => array(
            'step'             => 1,
    ...
    $wp_customize->add_setting('ecommerce_zone_post_page_content',array(
        'sanitize_callback' => 'ecommerce_zone_sanitize_checkbox',
        'default'           => 1,
    ));
    $wp_customize->add_control('ecommerce_zone_post_page_content',array(
        'type'        => 'checkbox',
        'label'       => esc_html__('Enable Post Page Content', 'ecommerce-zone'),
        'section'     => 'ecommerce_zone_post_settings',
        'description' => esc_html__('Check this box to enable content on post page.', 'ecommerce-zone'),
    ));

    $wp_customize->add_setting('ecommerce_zone_post_page_excerpt_length',array(
        'sanitize_callback' => 'ecommerce_zone_sanitize_number_range',
        'default'           => 30,
    ));
    $wp_customize->add_control('ecommerce_zone_post_page_excerpt_length',array(
        'label'       => esc_html__('Post Page Excerpt Length', 'ecommerce-zone'),
        'section'     => 'ecommerce_zone_post_settings',
        'type'        => 'range',
        'input_attrs' => array(
            'step'             => 1,
    ...
    $wp_customize->add_setting('ecommerce_zone_post_page_excerpt_suffix',array(
        'sanitize_callback' => 'sanitize_text_field',
        'default'           => '[...]',
    ));
    $wp_customize->add_control('ecommerce_zone_post_page_excerpt_suffix',array(
        'type'        => 'text',
        'label'       => esc_html__('Post Page Excerpt Suffix', 'ecommerce-zone'),
        'section'     => 'ecommerce_zone_post_settings',
        'description' => esc_html__('For Ex. [...], etc', 'ecommerce-zone'),
    ));

    $wp_customize->add_setting('ecommerce_zone_post_page_pagination',array(
        'sanitize_callback' => 'ecommerce_zone_sanitize_checkbox',
        'default'           => 1,
    ));
    $wp_customize->add_control('ecommerce_zone_post_page_pagination',array(
        'type'        => 'checkbox',
        'label'       => esc_html__('Enable Post Page Pagination', 'ecommerce-zone'),
        'section'     => 'ecommerce_zone_post_settings',
        'description' => esc_html__('Check this box to enable pagination on post page.', 'ecommerce-zone'),
    ));
    ...
    $wp_customize->add_setting( 'ecommerce_zone_single_post_page_image_border_radius', array(
        'default'              => '0',
        'transport'            => 'refresh',
        'sanitize_callback'    => 'ecommerce_zone_sanitize_number_range'
    ) );
    $wp_customize->add_control( 'ecommerce_zone_single_post_page_image_border_radius', array(
        'label'       => esc_html__( 'Single Post Page Image Border Radius','ecommerce-zone' ),
        'section'     => 'ecommerce_zone_post_settings',
        'type'        => 'range',
        'input_attrs' => array(
            'step'             => 1,
    ...
    $wp_customize->add_setting( 'ecommerce_zone_single_post_page_image_box_shadow', array(
        'default'              => '0',
        'transport'            => 'refresh',
        'sanitize_callback'    => 'ecommerce_zone_sanitize_number_range'
    ) );
    $wp_customize->add_control( 'ecommerce_zone_single_post_page_image_box_shadow', array(
        'label'       => esc_html__( 'Single Post Page Image Box Shadow','ecommerce-zone' ),
        'section'     => 'ecommerce_zone_post_settings',
        'type'        => 'range',
        'input_attrs' => array(
            'step'             => 1,
    ...
    $wp_customize->add_setting('ecommerce_zone_single_post_page_content',array(
        'sanitize_callback' => 'ecommerce_zone_sanitize_checkbox',
        'default'           => 1,
    ));
    $wp_customize->add_control('ecommerce_zone_single_post_page_content',array(
        'type'        => 'checkbox',
        'label'       => esc_html__('Enable Single Post Page Content', 'ecommerce-zone'),
        'section'     => 'ecommerce_zone_post_settings',
        'description' => esc_html__('Check this box to enable content on single post page.', 'ecommerce-zone'),
    ));
    ...
    $wp_customize->add_setting('ecommerce_zone_slider_title_setting', array(
        'default' => 1,
        'sanitize_callback' => 'ecommerce_zone_sanitize_checkbox'
    ));
    $wp_customize->add_control( new WP_Customize_Control($wp_customize,'ecommerce_zone_slider_title_setting',array(
        'label'          => __( 'Enable Disable Slider Title', 'ecommerce-zone' ),
        'section'        => 'ecommerce_zone_top_slider',
        'settings'       => 'ecommerce_zone_slider_title_setting',
        'type'           => 'checkbox',
    )));

    $wp_customize->add_setting('ecommerce_zone_slider_button_setting', array(
        'default' => 1,
        'sanitize_callback' => 'ecommerce_zone_sanitize_checkbox'
    ));
    $wp_customize->add_control( new WP_Customize_Control($wp_customize,'ecommerce_zone_slider_button_setting',array(
        'label'          => __( 'Enable Disable Slider Button', 'ecommerce-zone' ),
        'section'        => 'ecommerce_zone_top_slider',
        'settings'       => 'ecommerce_zone_slider_button_setting',
        'type'           => 'checkbox',
    )));
    ...
    for ( $ecommerce_zone_count = 1; $ecommerce_zone_count <= 3; $ecommerce_zone_count++ ) {
        ...
        $wp_customize->add_control( 'ecommerce_zone_top_slider_page' . $ecommerce_zone_count, array(
            ...
            'description' => __('Slider image size (830 x 300 px)','ecommerce-zone'),
            'section'  => 'ecommerce_zone_top_slider',
            'type'     => 'dropdown-pages'
        ) );
    }
    ...
    //Slider button text
    $wp_customize->add_setting('ecommerce_zone_slider_button_text',array(
        'default'=> '',
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('ecommerce_zone_slider_button_text',array(
        'label' => __('Slider Button Text','ecommerce-zone'),
        'section'=> 'ecommerce_zone_top_slider',
        'type'=> 'text'
    ));
    ...
    $wp_customize->add_setting('ecommerce_zone_show_hide_footer',array(
        'default' => true,
        'sanitize_callback' => 'ecommerce_zone_sanitize_checkbox'
    ));
    $wp_customize->add_control('ecommerce_zone_show_hide_footer',array(
        'type' => 'checkbox',
        'label' => __('Show / Hide Footer','ecommerce-zone'),
    ...
    $wp_customize->add_setting('ecommerce_zone_footer_bg_image_position',array(
        'default'=> 'scroll',
        'sanitize_callback' => 'ecommerce_zone_sanitize_choices'
    ));
    $wp_customize->add_control('ecommerce_zone_footer_bg_image_position',array(
        'type' => 'select',
        'label' => __('Footer Background Image Position','ecommerce-zone'),
        'choices' => array(
            'fixed' => __('fixed','ecommerce-zone'),
            'scroll' => __('scroll','ecommerce-zone'),
        ),
        'section'=> 'ecommerce_zone_site_footer_section',
    ));

    $wp_customize->add_setting('ecommerce_zone_footer_widget_heading_alignment',array(
        'default' => 'Left',
        'transport' => 'refresh',
        'sanitize_callback' => 'ecommerce_zone_sanitize_choices'
    ));
    $wp_customize->add_control('ecommerce_zone_footer_widget_heading_alignment',array(
        'type' => 'select',
        'label' => __('Footer Widget Heading Alignment','ecommerce-zone'),
        'section' => 'ecommerce_zone_site_footer_section',
        'choices' => array(
            'Left' => __('Left','ecommerce-zone'),
            'Center' => __('Center','ecommerce-zone'),
    ...
    $wp_customize->add_setting('ecommerce_zone_footer_widget_content_alignment',array(
        'default' => 'Left',
        'transport' => 'refresh',
        'sanitize_callback' => 'ecommerce_zone_sanitize_choices'
    ));
    $wp_customize->add_control('ecommerce_zone_footer_widget_content_alignment',array(
        'type' => 'select',
        'label' => __('Footer Widget Content Alignment','ecommerce-zone'),
        'section' => 'ecommerce_zone_site_footer_section',
        'choices' => array(
            'Left' => __('Left','ecommerce-zone'),
            'Center' => __('Center','ecommerce-zone'),
    ...
    $wp_customize->add_setting('ecommerce_zone_copyright_content_alignment',array(
        'default' => 'Right',
        'transport' => 'refresh',
        'sanitize_callback' => 'ecommerce_zone_sanitize_choices'
    ));
    $wp_customize->add_control('ecommerce_zone_copyright_content_alignment',array(
        'type' => 'select',
        'label' => __('Copyright Content Alignment','ecommerce-zone'),
        'section' => 'ecommerce_zone_site_footer_section',
        'choices' => array(
            'Left' => __('Left','ecommerce-zone'),
            'Center' => __('Center','ecommerce-zone'),
