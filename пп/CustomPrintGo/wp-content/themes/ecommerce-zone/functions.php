...
function ecommerce_zone_getpage_css($hook) {
    ...
    wp_localize_script('admin-notice-script','ecommerce_zone',
		array('admin_ajax'	=>	admin_url('admin-ajax.php'),'wpnonce'  =>	wp_create_nonce('ecommerce_zone_dismissed_notice_nonce')
		)
	);
	wp_enqueue_script('admin-notice-script');

    wp_localize_script( 'admin-notice-script', 'ecommerce_zone_ajax_object',
...
define('ECOMMERCE_ZONE_LIVE_DEMO',__('https://demo.themagnifico.net/ecommerce-wordpress-theme/','ecommerce-zone'));
}
if ( ! defined( 'ECOMMERCE_ZONE_GET_PREMIUM_PRO' ) ) {
define('ECOMMERCE_ZONE_GET_PREMIUM_PRO',__('https://www.themagnifico.net/products/ecommerce-wordpress-theme','ecommerce-zone'));
}
if ( ! defined( 'ECOMMERCE_ZONE_PRO_DOC' ) ) {
define('ECOMMERCE_ZONE_PRO_DOC',__('https://demo.themagnifico.net/eard/wathiqa/ecommerce-pro-doc','ecommerce-zone'));
}
if ( ! defined( 'ECOMMERCE_ZONE_FREE_DOC' ) ) {
define('ECOMMERCE_ZONE_FREE_DOC',__('https://demo.themagnifico.net/eard/wathiqa/ecommerce-zone-free-doc/','ecommerce-zone'));
}
...
function ecommerce_zone_info_page() {
	...
	<div class="wrap about-wrap ecommerce-zone-add-css">
			...
			<div class="feature-section three-col">
				...
				<div class="col">
					<div class="widgets-holder-wrap">
						...
						<p><a target="_blank" href="<?php echo esc_url( ECOMMERCE_ZONE_GET_PREMIUM_PRO ); ?>" class="button button-primary get prem">
				...
				<div class="col">
					<div class="widgets-holder-wrap">
						<h3><?php esc_html_e("Free Documentation", "ecommerce-zone"); ?></h3>
						<p><?php esc_html_e("Our guide is available if you require any help configuring and setting up the theme. Easy and quick way to setup the theme.", "ecommerce-zone"); ?></p>
						<p><a target="_blank" href="<?php echo esc_url( ECOMMERCE_ZONE_FREE_DOC ); ?>" class="button button-primary get">
							<?php esc_html_e("Free Documentation", "ecommerce-zone"); ?>
						</a></p>
					</div>
				</div>
			</div>
		...
		<div class="ecommerce-zone-button-container">
			<a target="_blank" href="<?php echo esc_url( ECOMMERCE_ZONE_GET_PREMIUM_PRO ); ?>" class="button button-primary get prem">
