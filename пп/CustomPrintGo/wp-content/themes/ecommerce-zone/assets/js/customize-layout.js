(function( $ ) {
	wp.customize.bind( 'ready', function() {
		...
		function ecommerce_zone_customizer_label( id, title ) {
			...
			if ( id === 'ecommerce_zone_preloader_hide' || id === 'ecommerce_zone_sticky_header' || id === 'ecommerce_zone_scroll_hide' || id === 'ecommerce_zone_woocommerce_shop_page_sidebar') {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-ecommerce_zone_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
			...
			if ( id === 'ecommerce_zone_show_hide_footer' || id === 'ecommerce_zone_show_hide_copyright') {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-ecommerce_zone_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
		...
		ecommerce_zone_customizer_label( 'ecommerce_zone_woocommerce_product_sale', 'Woocommerce Product Sale' );
		...
		//Footer
		ecommerce_zone_customizer_label( 'ecommerce_zone_show_hide_footer', 'Footer' );
